// Da 21st.dev — cnippet.dev/vertical-cut-reveal (id 18595): testo che si
// rivela con un wipe verticale a clip-path, carattere per carattere.
// Codice fedele all'originale (solo cn locale al posto dell'alias "@/").
// Usato per i due titoli della sezione cinematografica hero→cos'è (l'unico
// punto del sito dove ci si è presi la libertà di essere "spettacolari",
// per scelta esplicita — il resto del sito resta sobrio).
